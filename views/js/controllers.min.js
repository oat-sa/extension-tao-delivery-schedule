...
opts.byweekday=null);else{var byweekday=[],bynweekday=[];for(i=0;i<opts.byweekday.length;i++){var wday=opts.byweekday[i];"number"==typeof wday?byweekday.push(wday):!wday.n||opts.freq>RRule.MONTHLY?byweekday.push(wday.weekday):bynweekday.push([wday.weekday,wday.n])}opts.byweekday=plb(byweekday)?byweekday:null,opts.bynweekday=plb(bynweekday)?bynweekday:null}if(null===opts.byhour?opts.byhour=opts.freq<RRule.HOURLY?[opts.dtstart.getHours()]:null:"number"==typeof opts.byhour&&(opts.byhour=[opts.byhour]),null===opts.byminute?opts.byminute=opts.freq<RRule.MINUTELY?[opts.dtstart.getMinutes()]:null:"number"==typeof opts.byminute&&(opts.byminute=[opts.byminute]),null===opts.bysecond?opts.bysecond=opts.freq<RRule.SECONDLY?[opts.dtstart.getSeconds()]:null:"number"==typeof opts.bysecond&&(opts.bysecond=[opts.bysecond]),
opts.freq>=RRule.HOURLY)this.timeset=null;else{for(this.timeset=[],i=0;i<opts.byhour.length;i++)for(var hour=opts.byhour[i],j=0;j<opts.byminute.length;j++)for(var minute=opts.byminute[j],k=0;k<opts.bysecond.length;k++){var second=opts.bysecond[k];this.timeset.push(new dateutil.Time(hour,minute,second))}dateutil.sort(this.timeset)}};RRule.FREQUENCIES=["YEARLY","MONTHLY","WEEKLY","DAILY","HOURLY","MINUTELY","SECONDLY"],RRule.YEARLY=0,RRule.MONTHLY=1,RRule.WEEKLY=2,RRule.DAILY=3,RRule.HOURLY=4,RRule.MINUTELY=5,RRule.SECONDLY=6,RRule.MO=new Weekday(0),RRule.TU=new Weekday(1),RRule.WE=new Weekday(2),RRule.TH=new Weekday(3),RRule.FR=new Weekday(4),RRule.SA=new Weekday(5),
RRule.SU=new Weekday(6),RRule.DEFAULT_OPTIONS={freq:null,dtstart:null,interval:1,wkst:RRule.MO,count:null,until:null,bysetpos:null,bymonth:null,bymonthday:null,byyearday:null,byweekno:null,byweekday:null,byhour:null,byminute:null,bysecond:null,byeaster:null},RRule.parseText=function(text,language){return getnlp().parseText(text,language)},RRule.fromText=function(text,language){return getnlp().fromText(text,language)},RRule.optionsToString=function(options){var key,keys,defaultKeys,value,strValues,pairs=[];keys=Object.keys(options),defaultKeys=Object.keys(RRule.DEFAULT_OPTIONS);for(var i=0;i<keys.length;i++)if(contains(defaultKeys,keys[i])&&(key=keys[i].toUpperCase(),
...
ttr.isDone())throw new Error("Unexpected end");switch(ttr.symbol){case"day(s)":options.freq=RRule.DAILY,ttr.nextSymbol()&&(ON(),F());break;case"weekday(s)":options.freq=RRule.WEEKLY,options.byweekday=[RRule.MO,RRule.TU,RRule.WE,RRule.TH,RRule.FR],ttr.nextSymbol(),F();break;case"week(s)":options.freq=RRule.WEEKLY,ttr.nextSymbol()&&(ON(),F());break;case"month(s)":options.freq=RRule.MONTHLY,ttr.nextSymbol()&&(ON(),F());break;case"year(s)":options.freq=RRule.YEARLY,ttr.nextSymbol()&&(ON(),F());break;case"monday":case"tuesday":case"wednesday":case"thursday":case"friday":case"saturday":case"sunday":if(options.freq=RRule.WEEKLY,options.byweekday=[RRule[ttr.symbol.substr(0,2).toUpperCase()]],
!ttr.nextSymbol())return;for(;ttr.accept("comma");){if(ttr.isDone())throw new Error("Unexpected end");var wkd;if(!(wkd=decodeWKD()))throw new Error("Unexpected symbol "+ttr.symbol+", expected weekday");options.byweekday.push(RRule[wkd]),ttr.nextSymbol()}MDAYs(),F();break;case"january":case"february":case"march":case"april":case"may":case"june":case"july":case"august":case"september":case"october":case"november":case"december":if(options.freq=RRule.YEARLY,options.bymonth=[decodeM()],!ttr.nextSymbol())return;for(;ttr.accept("comma");){if(ttr.isDone())throw new Error("Unexpected end");var m;if(!(m=decodeM()))throw new Error("Unexpected symbol "+ttr.symbol+", expected month");
options.bymonth.push(m),ttr.nextSymbol()}ON(),F();break;default:throw new Error("Unknown symbol")}}function ON(){var on=ttr.accept("on"),the=ttr.accept("the");if(on||the)do{var nth,wkd,m;if(nth=decodeNTH())(wkd=decodeWKD())?(ttr.nextSymbol(),options.byweekday||(options.byweekday=[]),options.byweekday.push(RRule[wkd].nth(nth))):(options.bymonthday||(options.bymonthday=[]),options.bymonthday.push(nth),ttr.accept("day(s)"));else if(wkd=decodeWKD())ttr.nextSymbol(),options.byweekday||(options.byweekday=[]),options.byweekday.push(RRule[wkd]);else if("weekday(s)"==ttr.symbol)ttr.nextSymbol(),options.byweekday||(options.byweekday=[]),options.byweekday.push(RRule.MO),
options.byweekday.push(RRule.TU),options.byweekday.push(RRule.WE),options.byweekday.push(RRule.TH),options.byweekday.push(RRule.FR);else if("week(s)"==ttr.symbol){ttr.nextSymbol();var n;if(!(n=ttr.accept("number")))throw new Error("Unexpected symbol "+ttr.symbol+", expected week number");for(options.byweekno=[n[0]];ttr.accept("comma");){if(!(n=ttr.accept("number")))throw new Error("Unexpected symbol "+ttr.symbol+"; expected monthday");options.byweekno.push(n[0])}}else{if(!(m=decodeM()))return;ttr.nextSymbol(),options.bymonth||(options.bymonth=[]),options.bymonth.push(m)}}while(ttr.accept("comma")||ttr.accept("the")||ttr.accept("on"))}function decodeM(){switch(ttr.symbol){
case"january":return 1;case"february":return 2;case"march":return 3;case"april":return 4;case"may":return 5;case"june":return 6;case"july":return 7;case"august":return 8;case"september":return 9;case"october":return 10;case"november":return 11;case"december":return 12;default:return!1}}function decodeWKD(){switch(ttr.symbol){case"monday":case"tuesday":case"wednesday":case"thursday":case"friday":case"saturday":case"sunday":return ttr.symbol.substr(0,2).toUpperCase();default:return!1}}function decodeNTH(){switch(ttr.symbol){case"last":return ttr.nextSymbol(),-1;case"first":return ttr.nextSymbol(),1;case"second":return ttr.nextSymbol(),ttr.accept("last")?-2:2;case"third":
return ttr.nextSymbol(),ttr.accept("last")?-3:3;case"nth":var v=parseInt(ttr.value[1]);if(-366>v||v>366)throw new Error("Nth out of range: "+v);return ttr.nextSymbol(),ttr.accept("last")?-v:v;default:return!1}}function MDAYs(){ttr.accept("on"),ttr.accept("the");var nth;if(nth=decodeNTH())for(options.bymonthday=[nth],ttr.nextSymbol();ttr.accept("comma");){if(!(nth=decodeNTH()))throw new Error("Unexpected symbol "+ttr.symbol+"; expected monthday");options.bymonthday.push(nth),ttr.nextSymbol()}}function F(){if("until"==ttr.symbol){var date=Date.parse(ttr.text);if(!date)throw new Error("Cannot parse until date:"+ttr.text);options.until=new Date(date)}else ttr.accept("for")&&(options.count=ttr.value[0],
ttr.expect("number"))}var ttr=new Parser((language||ENGLISH).tokens);if(!ttr.start(text))return null;var options={};return S(),options},Parser=function(rules){this.rules=rules};Parser.prototype.start=function(text){return this.text=text,this.done=!1,this.nextSymbol()},Parser.prototype.isDone=function(){return this.done&&null==this.symbol},Parser.prototype.nextSymbol=function(){var best,bestSymbol,p=this;this.symbol=null,this.value=null;do{if(this.done)return!1;best=null;var match,rule;for(var name in this.rules)rule=this.rules[name],(match=rule.exec(p.text))&&(null==best||match[0].length>best[0].length)&&(best=match,bestSymbol=name);if(null!=best&&(this.text=this.text.substr(best[0].length),
...
for(i=0;i<this.colCnt;i++)segCols.push([]);for(i=0;i<segs.length;i++)segCols[segs[i].col].push(segs[i]);return segCols}});var View=fc.View=Class.extend({type:null,name:null,title:null,calendar:null,options:null,coordMap:null,el:null,isDisplayed:!1,isSkeletonRendered:!1,isEventsRendered:!1,start:null,end:null,intervalStart:null,intervalEnd:null,intervalDuration:null,intervalUnit:null,isSelected:!1,scrollerEl:null,scrollTop:null,widgetHeaderClass:null,widgetContentClass:null,highlightStateClass:null,nextDayThreshold:null,isHiddenDayHash:null,documentMousedownProxy:null,constructor:function(calendar,type,options,intervalDuration){this.calendar=calendar,this.type=this.name=type,
...
},renderDrag:function(dropLocation,seg){return this.dayGrid.renderDrag(dropLocation,seg)},destroyDrag:function(){this.dayGrid.destroyDrag()},renderSelection:function(range){this.dayGrid.renderSelection(range)},destroySelection:function(){this.dayGrid.destroySelection()}}),MonthView=fcViews.month=BasicView.extend({computeRange:function(date){var rowCnt,range=BasicView.prototype.computeRange.call(this,date);return this.isFixedWeeks()&&(rowCnt=Math.ceil(range.end.diff(range.start,"weeks",!0)),range.end.add(6-rowCnt,"weeks")),range},setGridHeight:function(height,isAuto){isAuto=isAuto||"variable"===this.opt("weekMode"),isAuto&&(height*=this.rowCnt/6),distributeHeight(this.dayGrid.rowEls,height,!isAuto);
},isFixedWeeks:function(){var weekMode=this.opt("weekMode");return weekMode?"fixed"===weekMode:this.opt("fixedWeekCount")}});MonthView.duration={months:1},MonthView.defaults={fixedWeekCount:!0},fcViews.basicWeek={type:"basic",duration:{weeks:1}},fcViews.basicDay={type:"basic",duration:{days:1}};var AGENDA_DEFAULTS={allDaySlot:!0,allDayText:"all-day",scrollTime:"06:00:00",slotDuration:"00:30:00",minTime:"00:00:00",maxTime:"24:00:00",slotEventOverlap:!0},AGENDA_ALL_DAY_EVENT_LIMIT=5,AgendaView=fcViews.agenda=View.extend({timeGrid:null,dayGrid:null,axisWidth:null,noScrollRowEls:null,bottomRuleEl:null,bottomRuleHeight:null,initialize:function(){this.timeGrid=new TimeGrid(this),
...
defaultDate:new Date,editable:!0,selectable:!0,selectHelper:!1,unselectAuto:!1,height:getCalendarHeight(),eventLimit:!1,select:_.noop,timeFormat:"H:mm",axisFormat:"HH:mm",loading:function(loading){loading?that.calendarLoading=$.Deferred():that.calendarLoading.resolve()},eventRender:function(fcEvent,$element){$element.addClass(eventService.classAttrPrefix+fcEvent.id),fcEvent.recurringEventIds&&$element.append('<span class="recurring-count">1</span>'),fcEvent.subEvent&&fcEvent.subEventNum&&$element.append('<span class="recurring-count">'+(fcEvent.subEventNum+1)+"</span>")},eventDrop:function(fcEvent,e,revertFunc){fcEvent.subEvent?(revertFunc(),feedback().warning(__("Sub delivery cannot be changed."))):saveEvent(fcEvent,revertFunc);
},eventResize:function(fcEvent,e,revertFunc){fcEvent.subEvent?(revertFunc(),feedback().warning(__("Sub delivery cannot be changed."))):saveEvent(fcEvent,revertFunc)},events:function(start,end,timezone,callback){$.ajax({url:helpers._url("index","CalendarApi","taoDeliverySchedule",{timeZone:eventService.getCurrentTZName()}),dataType:"json",data:{start:start.unix(),end:end.unix()},success:function(response){var events=[];that.exec("removeEvents"),$.each(response,function(key,event){var recurringEvents=eventService.getRecurringEvents(event);events.push(event),$.each(recurringEvents,function(rEventKey,rEventVal){events.push(rEventVal)})}),callback(events)}})}},options=_.assign(defaultOptions,options),
options.$container.fullCalendar(options)},this.exec=function(){return options.$container.fullCalendar.apply(options.$container,arguments)},this.addEvent=function(eventData){that.exec("renderEvent",eventData,!0)},this.getEvent=function(eventId){var deferred=$.Deferred(),fcEvent=that.exec("clientEvents",eventId);return 0===fcEvent.length?eventService.loadEvent(eventId,function(eventData){that.exec("renderEvent",eventData);var fcEvent=that.exec("clientEvents",eventId);deferred.resolve(fcEvent[0])}):deferred.resolve(fcEvent[0]),deferred.promise()},this.removeEvent=function(fcEvent){var eventsToBeRemoved;fcEvent&&(eventsToBeRemoved=[fcEvent.id],fcEvent.recurringEventIds&&fcEvent.recurringEventIds.length&&(eventsToBeRemoved=eventsToBeRemoved.concat(fcEvent.recurringEventIds)),
this.exec("removeEvents",function(eventToRemove){return-1!==eventsToBeRemoved.indexOf(eventToRemove.id)}))},this.goToEvent=function(eventId){var deferred=$.Deferred();return that.getEvent(eventId).done(function(fcEvent){eventService.getEventElement(fcEvent.id).length||that.exec("gotoDate",fcEvent.start),that.calendarLoading.done(function(){var pos,$eventElement=eventService.getEventElement(fcEvent.id),$scroller=options.$container.find(".fc-scroller");$scroller.length&&(pos=$eventElement.offset().top-$scroller.offset().top+$scroller.scrollTop(),$scroller.scrollTop(pos)),deferred.resolve(fcEvent)})}),deferred.promise()},"en"!==context.base_lang?require(["taoDeliverySchedule/lib/fullcalendar/lang/"+context.base_lang],function(){
that.init()},function(err){that.init()}):that.init()}}),function(window,document,undefined){!function(factory){"use strict";"function"==typeof define&&define.amd?define("taoDeliverySchedule/lib/qtip/jquery.qtip",["jquery"],factory):jQuery&&!jQuery.fn.qtip&&factory(jQuery)}(function($){"use strict";function QTip(target,options,id,attr){this.id=id,this.target=target,this.tooltip=NULL,this.elements={target:target},this._id=NAMESPACE+"-"+id,this.timers={img:{}},this.options=options,this.plugins={},this.cache={event:{},target:$(),disabled:FALSE,attr:attr,onTooltip:FALSE,lastClass:""},this.rendered=this.destroyed=this.disabled=this.waiting=this.hiddenDuringWait=this.positioning=this.triggering=FALSE;
...
return"area"===nodeName?(map=element.parentNode,mapName=map.name,element.href&&mapName&&"map"===map.nodeName.toLowerCase()?(img=$("img[usemap=#"+mapName+"]")[0],!!img&&img.is(":visible")):!1):/input|select|textarea|button|object/.test(nodeName)?!element.disabled:"a"===nodeName?element.href||isTabIndexNotNaN:isTabIndexNotNaN}function focusInputs(blurElems){focusableElems.length<1&&blurElems.length?blurElems.not("body").blur():focusableElems.first().focus()}function stealFocus(event){if(elem.is(":visible")){var targetOnTop,target=$(event.target),tooltip=current.tooltip,container=target.closest(SELECTOR);targetOnTop=container.length<1?FALSE:parseInt(container[0].style.zIndex,10)>parseInt(tooltip[0].style.zIndex,10),
targetOnTop||target.closest(SELECTOR)[0]===tooltip[0]||focusInputs(target),onLast=event.target===focusableElems[focusableElems.length-1]}}var current,onLast,prevState,elem,self=this,focusableElems={};$.extend(self,{init:function(){return elem=self.elem=$("<div />",{id:"qtip-overlay",html:"<div></div>",mousedown:function(){return FALSE}}).hide(),$(document.body).bind("focusin"+MODALSELECTOR,stealFocus),$(document).bind("keydown"+MODALSELECTOR,function(event){current&&current.options.show.modal.escape&&27===event.keyCode&&current.hide(event)}),elem.bind("click"+MODALSELECTOR,function(event){current&&current.options.show.modal.blur&&current.hide(event)}),self},update:function(api){
current=api,focusableElems=api.options.show.modal.stealfocus!==FALSE?api.tooltip.find("*").filter(function(){return focusable(this)}):[]},toggle:function(api,state,duration){var tooltip=($(document.body),api.tooltip),options=api.options.show.modal,effect=options.effect,type=state?"show":"hide",visible=elem.is(":visible"),visibleModals=$(MODALSELECTOR).filter(":visible:not(:animated)").not(tooltip);return self.update(api),state&&options.stealfocus!==FALSE&&focusInputs($(":focus")),elem.toggleClass("blurs",options.blur),state&&elem.appendTo(document.body),elem.is(":animated")&&visible===state&&prevState!==FALSE||!state&&visibleModals.length?self:(elem.stop(TRUE,FALSE),
$.isFunction(effect)?effect.call(elem,state):effect===FALSE?elem[type]():elem.fadeTo(parseInt(duration,10)||90,state?1:0,function(){state||elem.hide()}),state||elem.queue(function(next){elem.css({left:"",top:""}),$(MODALSELECTOR).length||elem.detach(),next()}),prevState=state,current.destroyed&&(current=NULL),self)}}),self.init()},OVERLAY=new OVERLAY,$.extend(Modal.prototype,{init:function(qtip){var tooltip=qtip.tooltip;return this.options.on?(qtip.elements.overlay=OVERLAY.elem,tooltip.addClass(MODALCLASS).css("z-index",QTIP.modal_zindex+$(MODALSELECTOR).length),qtip._bind(tooltip,["tooltipshow","tooltiphide"],function(event,api,duration){var oEvent=event.originalEvent;
...
}}})}(window,document),define("taoDeliverySchedule/calendar/tooltips/eventTooltip",["lodash","jquery","taoDeliverySchedule/lib/qtip/jquery.qtip"],function(_,$){"use strict";return function(options){var that=this,defaultOptions={prerender:!0,content:{text:" ",title:" "},position:{my:"bottom center",at:"top center",adjust:{scroll:!1,method:"shift"},viewport:$(document)},show:!1,hide:!1,style:{width:280,classes:"qtip-light qtip-shadow"}};this.init=function(){options="object"==typeof options?_.merge(defaultOptions,options):defaultOptions,this.tooltip=$("<div/>").qtip(options).qtip("api"),this.tooltip.elements.content.on("click",".js-close",function(e){e.preventDefault(),
that.hide()})},this.hide=function(){this.isShown()&&this.tooltip.hide()},this.isShown=function(){return this.tooltip.elements.tooltip.is(":visible")},this.set=function(options){this.tooltip.set(options)},this.validate=function(rules){var qtipApi,selector,$elements,formIsValid=!0;for(selector in rules)$elements=that.$form.find(selector),$elements.each(function(){var valid=rules[selector].validate.apply(this);qtipApi=$(this).qtip("api"),qtipApi||(qtipApi=$(this).qtip({content:{text:rules[selector].message},position:{target:"mouse",adjust:{x:5,y:5}}}).qtip("api")),$elements.toggleClass("error",!valid),qtipApi.toggle(!valid).disable(valid),formIsValid=formIsValid&&valid;
...
fix:function(){return l}},{reg:/.*/,fix:function(){return e}}],p={},v=function(e,t,r){if(arguments.length&&(e=e||((t.ownerDocument||t.document||t).parentWindow||n).event,this.originalEvent=e,this.isNative=r,this.isBean=!0,e)){var o,u,a,f,l,i=e.type,s=e.target||e.srcElement;if(this.target=s&&3===s.nodeType?s.parentNode:s,r){if(l=p[i],!l)for(o=0,u=h.length;u>o;o++)if(h[o].reg.test(i)){p[i]=l=h[o].fix;break}for(f=l(e,this,i),o=f.length;o--;)!((a=f[o])in this)&&a in e&&(this[a]=e[a])}}};return v.prototype.preventDefault=function(){this.originalEvent.preventDefault?this.originalEvent.preventDefault():this.originalEvent.returnValue=!1},v.prototype.stopPropagation=function(){
this.originalEvent.stopPropagation?this.originalEvent.stopPropagation():this.originalEvent.cancelBubble=!0},v.prototype.stop=function(){this.preventDefault(),this.stopPropagation(),this.stopped=!0},v.prototype.stopImmediatePropagation=function(){this.originalEvent.stopImmediatePropagation&&this.originalEvent.stopImmediatePropagation(),this.isImmediatePropagationStopped=function(){return!0}},v.prototype.isImmediatePropagationStopped=function(){return this.originalEvent.isImmediatePropagationStopped&&this.originalEvent.isImmediatePropagationStopped()},v.prototype.clone=function(e){var t=new v(this,this.element,this.isNative);return t.currentTarget=e,t},v}(),S=function(e,t){
return l||t||e!==a&&e!==n?e:f},x=function(){var e=function(e,t,n,r){var i=function(n,i){return t.apply(e,r?p.call(i,n?0:1).concat(r):i)},s=function(n,r){return t.__beanDel?t.__beanDel.ft(n.target,e):r},o=n?function(e){var t=s(e,this);return n.apply(t,arguments)?(e&&(e.currentTarget=t),i(e,arguments)):void 0}:function(e){return t.__beanDel&&(e=e.clone(s(e))),i(e,arguments)};return o.__beanDel=t.__beanDel,o},t=function(t,n,r,i,s,o,u){var f,a=w[n];"unload"==n&&(r=A(O,t,n,r,i)),a&&(a.condition&&(r=e(t,r,a.condition,o)),n=a.base||n),this.isNative=f=b[n]&&!!t[c],this.customType=!l&&!f&&n,this.element=t,this.type=n,this.original=i,this.namespaces=s,this.eventType=l||f?n:"propertychange",
this.target=S(t,f),this[c]=!!this.target[c],this.root=u,this.handler=e(t,r,null,o)};return t.prototype.inNamespaces=function(e){var t,n,r=0;if(!e)return!0;if(!this.namespaces)return!1;for(t=e.length;t--;)for(n=this.namespaces.length;n--;)e[t]==this.namespaces[n]&&r++;return e.length===r},t.prototype.matches=function(e,t,n){return!(this.element!==e||t&&this.original!==t||n&&this.handler!==n)},t}(),T=function(){var e={},t=function(n,r,i,s,o,u){var a=o?"r":"$";if(r&&"*"!=r){var c,l=0,h=e[a+r],p="*"==n;if(!h)return;for(c=h.length;c>l;l++)if((p||h[l].matches(n,i,s))&&!u(h[l],h,l,r))return}else for(var f in e)f.charAt(0)==a&&t(n,f.substr(1),i,s,o,u)},n=function(t,n,r,i){
var s,o=e[(i?"r":"$")+n];if(o)for(s=o.length;s--;)if(!o[s].root&&o[s].matches(t,r,null))return!0;return!1},r=function(e,n,r,i){var s=[];return t(e,n,r,null,i,function(e){return s.push(e)}),s},i=function(t){var n=!t.root&&!this.has(t.element,t.type,null,!1),r=(t.root?"r":"$")+t.type;return(e[r]||(e[r]=[])).push(t),n},s=function(n){t(n.element,n.type,null,n.handler,n.root,function(t,n,r){return n.splice(r,1),t.removed=!0,0===n.length&&delete e[(t.root?"r":"$")+t.type],!1})},o=function(){var t,n=[];for(t in e)"$"==t.charAt(0)&&(n=n.concat(e[t]));return n};return{has:n,get:r,put:i,del:s,entries:o}}(),C=function(e){N=arguments.length?e:a.querySelectorAll?function(e,t){
return t.querySelectorAll(e)}:function(){throw new Error("Bean: No selector engine installed")}},k=function(e,t){if(l||!t||!e||e.propertyName=="_on"+t){var n=T.get(this,t||e.type,null,!1),r=n.length,i=0;for(e=new E(e,this,!0),t&&(e.type=t);r>i&&!e.isImmediatePropagationStopped();i++)n[i].removed||n[i].handler.call(this,e)}},L=l?function(e,t,n){e[n?o:u](t,k,!1)}:function(e,t,n,r){var i;n?(T.put(i=new x(e,r||t,function(t){k.call(e,t,r)},k,null,null,!0)),r&&null==e["_on"+r]&&(e["_on"+r]=0),i.target.attachEvent("on"+i.eventType,i.handler)):(i=T.get(e,r||t,k,!0)[0],i&&(i.target.detachEvent("on"+i.eventType,i.handler),T.del(i)))},A=function(e,t,n,r,i){return function(){
r.apply(this,arguments),e(t,n,i)}},O=function(e,t,n,r){var a,f,i=t&&t.replace(s,""),o=T.get(e,i,null,!1),u={};for(a=0,f=o.length;f>a;a++)(!n||o[a].original===n)&&o[a].inNamespaces(r)&&(T.del(o[a]),!u[o[a].eventType]&&o[a][c]&&(u[o[a].eventType]={t:o[a].eventType,c:o[a].type}));for(a in u)T.has(e,u[a].t,null,!1)||L(e,u[a].t,!1,u[a].c)},M=function(e,t){var n=function(t,n){for(var r,i=v(e)?N(e,n):e;t&&t!==n;t=t.parentNode)for(r=i.length;r--;)if(i[r]===t)return t},r=function(e){var r=n(e.target,this);r&&t.apply(r,arguments)};return r.__beanDel={ft:n,selector:e},r},_=l?function(e,t,r){var i=a.createEvent(e?"HTMLEvents":"UIEvents");i[e?"initEvent":"initUIEvent"](t,!0,!0,n,1),
r.dispatchEvent(i)}:function(e,t,n){n=S(n,e),e?n.fireEvent("on"+t,a.createEventObject()):n["_on"+t]++},D=function(e,t,n){var o,u,a,f,r=v(t);if(r&&t.indexOf(" ")>0){for(t=d(t),f=t.length;f--;)D(e,t[f],n);return e}if(u=r&&t.replace(s,""),u&&w[u]&&(u=w[u].base),!t||r)(a=r&&t.replace(i,""))&&(a=d(a,".")),O(e,u,n,a);else if(m(t))O(e,null,t);else for(o in t)t.hasOwnProperty(o)&&D(e,o,t[o]);return e},P=function(e,t,n,r){var o,u,a,f,l,v,g;{if(void 0!==n||"object"!=typeof t){for(m(n)?(l=p.call(arguments,3),r=o=n):(o=r,l=p.call(arguments,4),r=M(n,o,N)),a=d(t),this===h&&(r=A(D,e,t,r,o)),f=a.length;f--;)g=T.put(v=new x(e,a[f].replace(s,""),r,o,d(a[f].replace(i,""),"."),l,!1)),
v[c]&&g&&L(e,v.eventType,!0,v.customType);return e}for(u in t)t.hasOwnProperty(u)&&P.call(this,e,u,t[u])}},H=function(e,t,n,r){return P.apply(null,v(n)?[e,n,t,r].concat(arguments.length>3?p.call(arguments,5):[]):p.call(arguments))},B=function(){return P.apply(h,arguments)},j=function(e,t,n){var o,u,a,f,l,r=d(t);for(o=r.length;o--;)if(t=r[o].replace(s,""),(f=r[o].replace(i,""))&&(f=d(f,".")),f||n||!e[c])for(l=T.get(e,t,null,!1),n=[!1].concat(n),u=0,a=l.length;a>u;u++)l[u].inNamespaces(f)&&l[u].handler.apply(e,n);else _(b[t],t,e);return e},F=function(e,t,n){for(var o,u,r=T.get(t,n,null,!1),i=r.length,s=0;i>s;s++)r[s].original&&(o=[e,r[s].type],(u=r[s].handler.__beanDel)&&o.push(u.selector),
o.push(r[s].original),P.apply(null,o));return e},I={on:P,add:H,one:B,off:D,remove:D,clone:F,fire:j,Event:E,setSelectorEngine:C,noConflict:function(){return t[e]=r,this}};if(n.attachEvent){var q=function(){var e,t=T.entries();for(e in t)t[e].type&&"unload"!==t[e].type&&D(t[e].element,t[e].type);n.detachEvent("onunload",q),n.CollectGarbage&&n.CollectGarbage()};n.attachEvent("onunload",q)}return C(),I}),define("taoDeliverySchedule/calendar/mediator",["taoDeliverySchedule/lib/bean.min"],function(bean){"use strict";var eventContainer={};return{on:function(eventName,eventHandler){return bean.on(eventContainer,eventName,eventHandler)},off:function(eventName){return bean.off(eventContainer,eventName);
},fire:function(eventName){var args=Array.prototype.slice.call(arguments,1);return bean.fire(eventContainer,eventName,args)}}}),define("taoDeliverySchedule/calendar/tooltips/editEventTooltip",["lodash","jquery","taoDeliverySchedule/calendar/tooltips/eventTooltip","tpl!taoDeliverySchedule/calendar/tooltips/eventTooltip","taoDeliverySchedule/calendar/mediator","taoDeliverySchedule/lib/qtip/jquery.qtip"],function(_,$,eventTooltip,tooltipTpl,mediator){"use strict";return function(){var that=this;eventTooltip.apply(this,arguments),this.init=function(){that.set({"events.hide":function(){mediator.fire("hide.editEventTooltip")},"position.adjust.resize":!0}),that.tooltip.elements.content.on("click",".js-edit-event",function(e){
e.preventDefault(),mediator.fire("edit.editEventTooltip")}),that.tooltip.elements.content.on("click",".js-delete-event",function(e){e.preventDefault(),mediator.fire("delete.editEventTooltip",that.getId())}),that.tooltip.elements.content.on("click",".js-go-to-parent-event",function(e){e.preventDefault(),mediator.fire("to-parent.editEventTooltip",that.getId())})},this.show=function(fcEvent){var tplOptions={start:fcEvent.start.format("ddd, MMMM D, H:mm"),end:fcEvent.end?fcEvent.end.format("ddd, MMMM D, H:mm"):!1,color:fcEvent.color||"transparent",fcEvent:fcEvent};that.tooltip.set({"content.text":tooltipTpl(tplOptions),"content.title":"<b>"+_.escape(fcEvent.title)+"</b>"
}),that.tooltip.elements.titlebar.css({"border-bottom":"2px solid "+tplOptions.color}),that.tooltip.show()},this.getId=function(){return that.tooltip.elements.tooltip.find('input[name="id"]').val()},this.getClassUri=function(){return that.tooltip.elements.tooltip.find('input[name="classUri"]').val()},this.init()}}),define("taoDeliverySchedule/calendar/tooltips/createEventTooltip",["lodash","jquery","helpers","taoDeliverySchedule/calendar/tooltips/eventTooltip","handlebars","i18n","taoDeliverySchedule/calendar/mediator","moment","taoDeliverySchedule/lib/qtip/jquery.qtip"],function(_,$,helpers,eventTooltip,Handlebars,__,mediator,moment){"use strict";return function(){
var that=this;eventTooltip.apply(this,arguments),this.validateRules={'[name="label"]':{validate:function(){return 0!==$(this).val().length},message:__("This field is required")}},this.init=function(){that.set({"content.title":__("Create a new delivery"),"style.width":400,"position.adjust.resize":!0,"events.hide":function(){mediator.fire("hide.createEventTooltip")}})},this.show=function(options){var start=moment.tz(options.start.clone().format("YYYY-MM-DD HH:mm"),options.timeZoneName),end=moment.tz(options.end.clone().format("YYYY-MM-DD HH:mm"),options.timeZoneName),startUTCStr=start.utc().format("YYYY-MM-DD HH:mm"),endUTCStr=end.utc().format("YYYY-MM-DD HH:mm"),tplOptions={
start:options.start.format("ddd, MMMM D, H:mm"),end:options.end?options.end.format("ddd, MMMM D, H:mm"):!1};$.ajax({url:helpers._url("createDeliveryForm","Main","taoDeliverySchedule"),type:"GET",data:{classUri:options.classUri,id:options.id},success:function(response){var $form,tpl=Handlebars.compile(response);that.tooltip.set({"content.text":tpl(tplOptions),"position.target":options.target||options.e.target}),that.tooltip.show(),$form=that.getForm(),$form.find("#label").focus(),$form.find('[name="start"]').val(startUTCStr),$form.find('[name="end"]').val(endUTCStr),that.$form=$form,that.$form.on("keyup","input, select",function(){that.validate(that.validateRules);
}),that.$form.find('[name="test"]').on("change",function(){var text=$(this).find('option[value="'+$(this).val()+'"]').text(),$label=$form.find("#label");$label.val(text).focus()}).trigger("change"),that.tooltip.elements.content.find(".js-create-event").on("click",function(e){e.preventDefault(),$form.submit()}),$form.on("submit",function(e){e.preventDefault(),that.submit($(this),e)})}})},this.submit=function(e){this.validate(this.validateRules)&&mediator.fire("submit.createEventTooltip",that.getFormData())},this.getForm=function(){return that.tooltip.elements.content.find("form")},this.getFormData=function(){var data={},$form=that.getForm();return $form.serializeArray().map(function(x){
data[x.name]=x.value}),data},this.init()}}),define("taoDeliverySchedule/calendar/modals/modal",["lodash","jquery","taoDeliverySchedule/lib/qtip/jquery.qtip"],function(_,$){"use strict";return function(options){var that=this,defaultOptions={prerender:!0,content:{text:" ",title:" "},position:{my:"center",at:"center",target:$(window),adjust:{scroll:!1}},show:{ready:!1,modal:{on:!0,blur:!1}},hide:!1,style:{width:800,classes:"dialogue qtip-light qtip-shadow"}};this.init=function(){$.fn.qtip.modal_zindex=8800,options=_.merge(defaultOptions,options),this.modal=$("<div />").qtip(options).qtip("api")},this.hide=function(){that.isShown()&&this.modal.hide()},this.isShown=function(){
return this.modal.elements.tooltip.is(":visible")},this.set=function(options){this.modal.set(options)},this.init()}}),define("taoDeliverySchedule/calendar/testTakersService",["lodash","jquery","helpers","ui/feedback","layout/loading-bar"],function(_,$,helpers,feedback,loadingBar){"use strict";function TestTakersService(){if(null!==instance)throw new Error("Cannot instantiate more than one TestTakersService, use TestTakersService.getInstance()");this.loadTestTakers=function(options){var deferred=$.Deferred();return $.ajax({url:helpers._url("index","TestTakersApi","taoDeliverySchedule"),type:"GET",data:options,success:function(response){deferred.resolve(response);
},error:function(xhr,err){deferred.rejext(xhr)}}),deferred.promise()}}var instance=null;return TestTakersService.getInstance=function(){return null===instance&&(instance=new TestTakersService),instance},TestTakersService.getInstance()}),define("taoDeliverySchedule/calendar/widgets/testTakersList",["lodash","jquery","handlebars","i18n","ui/feedback","taoDeliverySchedule/calendar/testTakersService"],function(_,$,Handlebars,__,feedback,testTakersService){"use stirct";return function(options){var assignedSummaryTpl,excludedSummaryTpl,that=this,$container=options.container,$assignedList=$container.find(".js-assigned-tt-list"),$excludedList=$container.find(".js-excluded-tt-list");
this.init=function(){$container.on("keyup",".tt-list__filter",function(){that.applyFilter($(this))}),$container.on("click",".js-reset-filter",function(e){e.preventDefault();var $input=$(this).closest("td").find(".tt-list__filter");$input.val(""),that.applyFilter($input)}),$container.find(".tt-select").on("change",function(){that.moveOptions($(this).find("option:selected"))}),assignedSummaryTpl=Handlebars.compile($(".js-assigned-summary-wrap").html()),excludedSummaryTpl=Handlebars.compile($(".js-excluded-summary-wrap").html()),$(".js-assigned-summary-wrap").empty(),$(".js-excluded-summary-wrap").empty(),options.data&&that.render(options.data)},this.moveOptions=function($options){
return $options.each(function(){var $option=$(this);$.contains($assignedList[0],$option[0])?$excludedList.append($option):$assignedList.append($option)}),that.unselectOptions(),$(".tt-list__filter").each(function(){that.applyFilter($(this))}),$options},this.unselectOptions=function(){$(".tt-select option").each(function(){$(this)[0].selected=!1})},this.render=function(data){$assignedList.empty(),$excludedList.empty(),$.each(data.ttassigned,function(key,val){$assignedList.append($('<option value="'+val.uri+'">'+val.label+"</option>"))}),$.each(data.ttexcluded,function(key,val){$excludedList.append($('<option value="'+val.uri+'">'+val.label+"</option>"))}),that.updateSummary();
},this.updateGroups=function(groups){testTakersService.loadTestTakers({groups:groups,uri:options.deliveryId}).done(function(data){that.render(data)})},this.updateSummary=function(){var data={ttassigned:{total:$assignedList.find("option").length,filtered:$assignedList.find("option.filtered").length},ttexcluded:{total:$excludedList.find("option").length,filtered:$excludedList.find("option.filtered").length}};data.ttexcluded.message=data.ttexcluded.total?__("%d test-taker(s) are excluded",String(data.ttexcluded.total)):"&nbsp;",data.ttassigned.message=__("Delivery is assigned to %d test-takers",String(data.ttassigned.total)),$(".js-assigned-summary-wrap").html(assignedSummaryTpl(data.ttassigned)),
$(".js-excluded-summary-wrap").html(excludedSummaryTpl(data.ttexcluded))},this.applyFilter=function($input){var $container=$input.closest("td"),$select=$container.find(".tt-select"),str=$input.val(),filtered=0;$select.find("span > option").unwrap(),$select.find("option").removeClass("filtered").each(function(key,option){var $option=$(option);$option.text().indexOf(str)<0&&($option.addClass("filtered").wrap("<span>").parent().hide(),filtered++)}),that.updateSummary()},this.init()}}),!function(a,b){"use strict";"function"==typeof define&&define.amd?define("taoDeliverySchedule/lib/moment-timezone-with-data.min",["moment"],b):"object"==typeof exports?module.exports=b(require("moment")):b(a.moment);
}(this,function(a){"use strict";function b(a){return a>96?a-87:a>64?a-29:a-48}function c(a){var c,d=0,e=a.split("."),f=e[0],g=e[1]||"",h=1,i=0,j=1;for(45===a.charCodeAt(0)&&(d=1,j=-1),d;d<f.length;d++)c=b(f.charCodeAt(d)),i=60*i+c;for(d=0;d<g.length;d++)h/=60,c=b(g.charCodeAt(d)),i+=c*h;return i*j}function d(a){for(var b=0;b<a.length;b++)a[b]=c(a[b])}function e(a,b){for(var c=0;b>c;c++)a[c]=Math.round((a[c-1]||0)+6e4*a[c]);a[b-1]=1/0}function f(a,b){var c,d=[];for(c=0;c<b.length;c++)d[c]=a[b[c]];return d}function g(a){var b=a.split("|"),c=b[2].split(" "),g=b[3].split(""),h=b[4].split(" ");return d(c),d(g),d(h),e(h,g.length),{name:b[0],abbrs:f(b[1].split(" "),g),
offsets:f(c,g),untils:h}}function h(a){a&&this._set(g(a))}function i(a){return(a||"").toLowerCase().replace(/\//g,"_")}function j(a){var b,c,d;for("string"==typeof a&&(a=[a]),b=0;b<a.length;b++)c=a[b].split("|")[0],d=i(c),v[d]=a[b],x[d]=c}function k(a,b){a=i(a);var c,d=v[a];return d instanceof h?d:"string"==typeof d?(d=new h(d),v[a]=d,d):w[a]&&b!==k&&(c=k(w[a],k))?(d=v[a]=new h,d._set(c),d.name=x[a],d):null}function l(){var a,b=[];for(a in x)x.hasOwnProperty(a)&&(v[a]||v[w[a]])&&x[a]&&b.push(x[a]);return b.sort()}function m(a){var b,c,d,e;for("string"==typeof a&&(a=[a]),b=0;b<a.length;b++)c=a[b].split("|"),d=i(c[0]),e=i(c[1]),w[d]=e,x[d]=c[0],w[e]=d,x[e]=c[1];
}function n(a){j(a.zones),m(a.links),r.dataVersion=a.version}function o(a){return o.didShowError||(o.didShowError=!0,q("moment.tz.zoneExists('"+a+"') has been deprecated in favor of !moment.tz.zone('"+a+"')")),!!k(a)}function p(a){return!(!a._a||void 0!==a._tzm)}function q(a){"undefined"!=typeof console&&"function"==typeof console.error&&console.error(a)}function r(b){var c=Array.prototype.slice.call(arguments,0,-1),d=arguments[arguments.length-1],e=k(d),f=a.utc.apply(null,c);return e&&!a.isMoment(b)&&p(f)&&f.add(e.parse(f),"minutes"),f.tz(d),f}function s(a){return function(){return this._z?this._z.abbr(this):a.call(this)}}function t(a){return function(){return this._z=null,
a.apply(this,arguments)}}if(void 0!==a.tz)return q("Moment Timezone "+a.tz.version+" was already loaded "+(a.tz.dataVersion?"with data from ":"without any data")+a.tz.dataVersion),a;var u="0.4.0",v={},w={},x={},y=a.version.split("."),z=+y[0],A=+y[1];(2>z||2===z&&6>A)&&q("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js "+a.version+". See momentjs.com"),h.prototype={_set:function(a){this.name=a.name,this.abbrs=a.abbrs,this.untils=a.untils,this.offsets=a.offsets},_index:function(a){var b,c=+a,d=this.untils;for(b=0;b<d.length;b++)if(c<d[b])return b},parse:function(a){var b,c,d,e,f=+a,g=this.offsets,h=this.untils,i=h.length-1;for(e=0;i>e;e++)if(b=g[e],
c=g[e+1],d=g[e?e-1:e],c>b&&r.moveAmbiguousForward?b=c:b>d&&r.moveInvalidForward&&(b=d),f<h[e]-6e4*b)return g[e];return g[i]},abbr:function(a){return this.abbrs[this._index(a)]},offset:function(a){return this.offsets[this._index(a)]}},r.version=u,r.dataVersion="",r._zones=v,r._links=w,r._names=x,r.add=j,r.link=m,r.load=n,r.zone=k,r.zoneExists=o,r.names=l,r.Zone=h,r.unpack=g,r.unpackBase60=c,r.needsOffset=p,r.moveInvalidForward=!0,r.moveAmbiguousForward=!1;var B=a.fn;a.tz=r,a.defaultZone=null,a.updateOffset=function(b,c){var d,e=a.defaultZone;void 0===b._z&&(e&&p(b)&&!b._isUTC&&(b._d=a.utc(b._a)._d,b.utc().add(e.parse(b),"minutes")),b._z=e),b._z&&(d=b._z.offset(b),
Math.abs(d)<16&&(d/=60),void 0!==b.utcOffset?b.utcOffset(-d,c):b.zone(d,c))},B.tz=function(b){return b?(this._z=k(b),this._z?a.updateOffset(this):q("Moment Timezone has no data for "+b+". See http://momentjs.com/timezone/docs/#/data-loading/."),this):this._z?this._z.name:void 0},B.zoneName=s(B.zoneName),B.zoneAbbr=s(B.zoneAbbr),B.utc=t(B.utc),a.tz.setDefault=function(b){return(2>z||2===z&&9>A)&&q("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js "+a.version+"."),a.defaultZone=b?k(b):null,a};var C=a.momentProperties;return"[object Array]"===Object.prototype.toString.call(C)?(C.push("_z"),C.push("_a")):C&&(C._z=null),n({version:"2015d",
...
},this.initForm=function(data){that.$form=that.modal.elements.content.find(".edit-delivery-form"),data.resultserver&&that.$form.find('select[name="resultserver"] option[value="'+data.resultserver+'"]').attr("selected","selected"),that.$form.on("submit",function(e){if(e.preventDefault(),that.validate()){var formData=that.getFormData(),fcEvent=eventService.getEventById(formData.id);_.assign(fcEvent,formData),fcEvent.subEvent||(fcEvent.start=moment(formData.start),fcEvent.end=moment(formData.end)),eventService.saveEvent(fcEvent,function(){initialData=that.getFormData(),that.hide()})}}),that.parseRrule(data),$(".js-repeat-toggle").prop("checked",!!data.recurrence).on("change",function(){
$(".repeat-event-table").toggle($(this).is(":checked")),that.updateRruleValue()}).trigger("change"),$('[name="rrule[freq]"]').on("change",function(){$(".js-byday-row").toggle($(this).val()==RRule.WEEKLY)}).trigger("change"),$('[name^="rrule["]').on("change",function(){that.updateRruleValue()}),that.$form.on("change","input, select",function(){that.validate()}),that.$form.on("click",'[type="submit"]',function(){that.$form.submit()}),initialData=that.getFormData()},this.initGroupTree=function(options){that.groupTree=new GenerisTreeSelectClass(".js-groups",helpers._url("getData","GenerisTree","tao"),{checkedNodes:options.groups,serverParameters:{openNodes:["http://www.tao.lu/Ontologies/TAOGroup.rdf#Group"],
rootNode:"http://www.tao.lu/Ontologies/TAOGroup.rdf#Group"},paginate:10,onChangeCallback:function(){testTakersList.updateGroups(that.groupTree.getChecked())}})},this.initDatepickers=function(){for(var start=moment($(".js-delivery-start").val()).parseZone(),end=moment($(".js-delivery-end").val()).parseZone(),timeList=[],i=0;24>i;i++){var hour=10>i?"0"+i:i;timeList.push(hour+":00",hour+":30")}$(".js-delivery-start-date, .js-delivery-end-date").datepicker({dateFormat:"yy-mm-dd",beforeShow:function(textbox,instance){instance.dpDiv.addClass("edit-delivery-form__datepicker")}}),$(".js-delivery-start-date").datepicker("setDate",start.format("YYYY-MM-DD")),$(".js-delivery-end-date").datepicker("setDate",end.format("YYYY-MM-DD")),
$(".js-delivery-start-time, .js-delivery-end-time").autocomplete({source:function(request,response){response(_.filter(timeList,function(val){return 0===val.indexOf(request.term)}))},minLength:0,close:function(event,ui){$(this).trigger("change")},appendTo:".edit-delivery-form"}).click(function(event,ui){$(this).autocomplete("search","")}),$(".js-delivery-start-time, .js-delivery-end-time").on("blur",function(e){$(this).val($(this).val().substr(0,5))}),$(".js-delivery-start-time").val(start.format("HH:mm")),$(".js-delivery-end-time").val(end.format("HH:mm"))},this.updateDatetime=function(){var startMoment=that.getStartMoment(),endMoment=that.getEndMoment();$(".js-delivery-start").val(startMoment.format("YYYY-MM-DDTHH:mm:ssZZ")),
$(".js-delivery-end").val(endMoment.format("YYYY-MM-DDTHH:mm:ssZZ"))},this.updateRruleValue=function(formData){var rrule,value="",data=formData||that.$form.serializeObject(),rruleData=_.clone(data.rrule);if(rruleData){if(rruleData.dtstart=that.getStartMoment().clone().utc().toDate(),$(".js-repeat-toggle").is(":checked")){var rrule=new RRule(rruleData);value=rrule.toString(),$(".js-rrule-summary").text(RRule.fromString(rrule.toString()).toText())}return $('[name="recurrence"]').val(value),value}},this.parseRrule=function(){var rule,rrule,startMoment,$rruleInput=$('[name="recurrence"]');0!==$rruleInput.length&&$('[name="recurrence"]').val()&&(rule=$('[name="recurrence"]').val().toUpperCase(),
startMoment=that.getStartMoment(),rule+=";DTSTART="+startMoment.clone().utc().format("YYYYMMDDTHHmmss")+"Z",rrule=RRule.fromString(rule),$.each(rrule.options,function(key,value){if(rrule.origOptions[key]){var $input=$('[name^="rrule['+key.toLowerCase()+']"]');$input&&$input.length&&(_.isArray(value)?$.each(value,function(i,num){$input.eq(num).prop("checked",!0)}):$input.val(value))}}),this.updateRruleValue())},this.getExecutionsMessage=function(executions){var message=__("No information available");return executions>=0&&(message=0==executions?__("No attempt has been started yet."):1==executions?__("There is currently 1 attempt"):__("There are currently %s attempts",String(executions))),
message},this.validate=function(){var qtipApi,$elements,rules={".js-delivery-end-time, .js-delivery-start-time":{validate:function(){return/^\d\d:\d\d$/.test($(this).val())},message:__("The format of time is invalid")},".js-delivery-end-date, .js-delivery-start-date":{validate:function(){return/^\d\d\d\d-\d\d-\d\d$/.test($(this).val())},message:__("The format of date is invalid")},".js-label":{validate:function(){return 0!==$(this).val().length},message:__("This field is required")},".js-maxexec":{validate:function(){return/^\d*$/.test($(this).val())},message:__("Value must be a number")},'[name="resultserver"]':{validate:function(){return 0!==$.trim($(this).val()).length;
},message:__("This field is required")},'[name="rrule[count]"]':{validate:function(){return/^\d*$/.test($(this).val())||!$(".js-repeat-toggle").is(":checked")},message:__("Value must be a number")}},formIsValid=!0;that.updateDatetime();for(var selector in rules)$elements=that.$form.find(selector),$elements.each(function(){var valid=rules[selector].validate.apply(this);qtipApi=$(this).qtip("api"),qtipApi||(qtipApi=$(this).qtip({content:{text:rules[selector].message},position:{target:"mouse",adjust:{x:5,y:5}}}).qtip("api")),$elements.toggleClass("error",!valid),qtipApi.toggle(!valid).disable(valid),formIsValid=formIsValid&&valid});return formIsValid},this.getStartMoment=function(){
var startVal=$(".js-delivery-start-date").val()+" "+$(".js-delivery-start-time").val(),startMoment=moment.tz(startVal,this.getCurrentTZName());return startMoment},this.getEndMoment=function(){var endVal=$(".js-delivery-end-date").val()+" "+$(".js-delivery-end-time").val(),endMoment=moment.tz(endVal,this.getCurrentTZName());return endMoment},this.getCurrentTZName=function(){var timeZone=$.trim($(".js-delivery-time-zone").find("option:selected").text());return""===timeZone&&(timeZone=this.tz||"UTC"),timeZone},this.getFormData=function(){var data={};return that.updateDatetime(),that.updateRruleValue(),data=that.$form.serializeObject(),data.ttexcluded=[],$(".js-excluded-tt-list option").each(function(){
...
"use strict";function DeliverySchedule(){timeZoneListTpl=Handlebars.compile(timeZoneListTpl);var calendar,editEventTooltip,createEventTooltip,editEventModal,tree,that=this,$treeElt=$("#tree-manage_delivery_schedule"),$calendarContainer=$(".js-delivery-calendar"),timeZone=$(".js-delivery-calendar").data("time-zone-name")||"UTC",$tzSelect=$(timeZoneListTpl());this.start=function(){that.initTree(),eventService.setTZ(timeZone),calendar=new Calendar({$container:$calendarContainer,select:function(start,end,e){editEventTooltip.hide(),actionManager.exec("delivery-new",_.extend(actionManager._resourceContext,{start:start,end:end,e:e,target:e.target,timeZone:$tzSelect.val(),
timeZoneName:eventService.getCurrentTZName()},{action:actionManager.getBy("delivery-new")}))},eventClick:function(fcEvent,e){createEventTooltip.hide(),that.selectEvent(fcEvent.id,!0,e)},eventResizeStart:function(fcEvent,e){that.hideTooltips()},viewRender:function(){$(".fc-scroller").on("scroll",function(e){editEventTooltip.tooltip.elements.tooltip.is(":visible")&&editEventTooltip.tooltip.reposition(e),createEventTooltip.tooltip.elements.tooltip.is(":visible")&&createEventTooltip.tooltip.reposition(e)})},viewDisplay:function(){that.hideTooltips()},viewDestroy:function(){that.hideTooltips()}}),that.initTzSelect(),that.initTooltips(),binder.register("schedule_month_mode",function(){
that.hideTooltips(),calendar.exec("changeView","month")}),binder.register("schedule_week_mode",function(){that.hideTooltips(),calendar.exec("changeView","agendaWeek")}),binder.register("schedule_day_mode",function(){that.hideTooltips(),calendar.exec("changeView","agendaDay")}),binder.register("delivery-new",function(context){that.showCreateEventTooltip(context)}),binder.register("delivery-edit",function(context){that.showEditEventModal(context)}),binder.register("delivery-delete",function(context){eventService.deleteEvent(context.uri,function(data){var fcEvent=eventService.getEventById(data.id);calendar.removeEvent(fcEvent),that.hideTooltips()})}),binder.register("delivery-select",function(treeInstance){
var subEventSelected,fcEvent=eventService.getEventById(treeInstance.uri);editEventTooltip.isShown()&&editEventTooltip.getId()===treeInstance.uri||(subEventSelected=editEventTooltip.isShown()&&_.contains(fcEvent.recurringEventIds,editEventTooltip.getId()),subEventSelected||that.selectEvent(treeInstance.uri))}),binder.register("class-select",function(treeInstance){that.hideTooltips()})},this.initTooltips=function(){$.fn.qtip.zindex=9e3,editEventTooltip=new EditEventTooltip,mediator.on("edit.editEventTooltip",function(){actionManager.exec("delivery-edit",_.extend(actionManager._resourceContext,{action:actionManager.getBy("delivery-edit")}))}),mediator.on("hide.editEventTooltip",function(){
eventService.highlightEvent(!1)}),mediator.on("delete.editEventTooltip",function(eventId){eventService.deleteEvent(eventId,function(data){var fcEvent=eventService.getEventById(data.id);calendar.removeEvent(fcEvent),that.hideTooltips()})}),mediator.on("to-parent.editEventTooltip",function(eventId){var fcEvent=eventService.getEventById(eventId);fcEvent.parentEventId&&that.selectEvent(fcEvent.parentEventId,!0)}),createEventTooltip=new CreateEventTooltip,mediator.on("submit.createEventTooltip",function(data){eventService.createEvent({data:data,success:that.hideTooltips})}),mediator.on("hide.createEventTooltip",function(data){calendar.exec("unselect")}),editEventModal=new EditEventModal;
},this.initTzSelect=function(){$tzSelect.find("option:contains("+timeZone+")").attr("selected","selected"),$(".fc-toolbar .fc-right").prepend($tzSelect),$tzSelect.on("change",function(){that.hideTooltips(),timeZone=eventService.getCurrentTZName(),calendar.exec("refetchEvents")})},this.initTree=function(){tree=$.tree.reference($treeElt),$($treeElt).on("refresh.taotree",function(){calendar.exec("refetchEvents")}),$($treeElt).children("ul").on("click",function(){editEventTooltip.tooltip.elements.tooltip.find('input[name="id"]').val("")})},this.hideTooltips=function(){editEventTooltip.hide(),createEventTooltip.hide()},this.showEditEventTooltip=function(fcEvent,e){
var $moreLinks,$eventElement=eventService.getEventElement(fcEvent.id);calendar.exec("unselect"),$eventElement.length&&(eventService.highlightEvent(fcEvent),"undefined"==typeof e||e.isTrigger?($eventElement.is(":visible")||($moreLinks=$eventElement.closest(".fc-content-skeleton").find("a.fc-more"),$eventElement=$moreLinks.eq(0)),editEventTooltip.set({"position.target":$eventElement}),editEventTooltip.set({"position.adjust.y":4,"position.adjust.x":0,"position.my":"bottom center","position.at":"top center"})):editEventTooltip.set({"position.adjust.y":e.offsetY||e.pageY-$eventElement.offset().top,"position.adjust.x":e.offsetX||e.pageX-$eventElement.offset().left,
"position.target":e.currentTarget,"position.my":"bottom center","position.at":"top left"}),editEventTooltip.show(fcEvent))},this.showCreateEventTooltip=function(context){createEventTooltip.show(context)},this.showEditEventModal=function(context){var fcEventId=editEventTooltip.isShown()?editEventTooltip.getId():context.uri,fcEvent=eventService.getEventById(fcEventId);this.hideTooltips(),editEventModal.show(fcEvent)},this.selectEvent=function(eventId,selectTreeNode,e){calendar.goToEvent(eventId).done(function(fcEvent){that.showEditEventTooltip(fcEvent,e),selectTreeNode&&that.selectTreeNode(fcEvent.id)})},this.selectTreeNode=function(eventId){tree.deselect_branch(tree.selected),
calendar.getEvent(eventId).done(function(fcEvent){return fcEvent.subEvent?void that.selectTreeNode(fcEvent.parentEventId):(0===$("#tree-manage_delivery_schedule #"+fcEvent.id).length&&(tree.select_branch($("#"+fcEvent.classId+" .more")),$treeElt.one("delete.taotree",function(e,elt){$(elt).hasClass("more")&&tree.select_branch($("#"+eventId))})),void(fcEvent.classId?tree.open_branch("#"+fcEvent.classId,!1,function(){tree.select_branch($("#"+fcEvent.id))}):tree.select_branch($("#"+fcEvent.id))))})}}return new DeliverySchedule}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),
