...
data.ttexcluded.push(this.value)}),data.groups=that.groupTree.getChecked(),data},this.init()}}),define("taoDeliverySchedule/controller/Main/index",["lodash","jquery","i18n","handlebars","layout/actions/binder","taoDeliverySchedule/calendar/calendar","taoDeliverySchedule/calendar/eventService","taoDeliverySchedule/calendar/tooltips/editEventTooltip","taoDeliverySchedule/calendar/tooltips/createEventTooltip","taoDeliverySchedule/calendar/modals/editEventModal","layout/actions","ui/feedback","text!timeZoneList","taoDeliverySchedule/calendar/mediator","taoDeliverySchedule/lib/rrule/rrule.amd","css!/taoDeliverySchedule/views/css/taodeliveryschedule"],function(_,$,__,Handlebars,binder,Calendar,eventService,EditEventTooltip,CreateEventTooltip,EditEventModal,actionManager,feedback,timeZoneListTpl,mediator){
...
calendar.getEvent(eventId).done(function(fcEvent){return fcEvent.subEvent?void that.selectTreeNode(fcEvent.parentEventId):(0===$("#tree-manage_delivery_schedule #"+fcEvent.id).length&&(tree.select_branch($("#"+fcEvent.classId+" .more")),$treeElt.one("delete.taotree",function(e,elt){$(elt).hasClass("more")&&tree.select_branch($("#"+eventId))})),void(fcEvent.classId?tree.open_branch("#"+fcEvent.classId,!1,function(){tree.select_branch($("#"+fcEvent.id))}):tree.select_branch($("#"+fcEvent.id))))})}}return new DeliverySchedule});
