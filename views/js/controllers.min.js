...
}),that.$form.find('[name="test"]').on("change",function(){var text=$(this).find('option[value="'+$(this).val()+'"]').text(),$label=$form.find("#label");$label.val(text).focus()}).trigger("change"),that.tooltip.elements.content.find(".js-create-event").on("click",function(){$form.submit()}),$form.on("submit",function(e){e.preventDefault(),that.submit($(this),e)})}})},this.submit=function(e){this.validate(this.validateRules)&&mediator.fire("submit.createEventTooltip",that.getFormData())},this.getForm=function(){return that.tooltip.elements.content.find("form")},this.getFormData=function(){var data={},$form=that.getForm();return $form.serializeArray().map(function(x){
